...
////////////LGT_MAC////////////////////LGT_MAC///////////////////////////////LGT_MAC///////////////////////////
	...
	char leveling_sta = 0;
	int ii_setup = 0;
	extern float /*save_feedtate,*/resume_e_position,resume_x_position,resume_y_position;
	...
	void LGT_Init()
	{
		...
		#endif
//		LGT_LCD.LGT_Screen_System_Reset();
		delay(600);  //delay is necessary here
		//if (card.cardOK)
